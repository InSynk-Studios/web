...
const Error404 = () => {
  return (
    <div className="h-screen justify-center ">
      <center className="m-auto mt-32">
        <svg
          className="emoji-404 h-32 w-32 lg:h-52 lg:w-52"
      ...
      <center className="mt-6">
        <Link href="/">
          <a className="rounded-md bg-orange-300 dark:bg-purple-300 p-3 font-mono text-xl text-gray-500 hover:shadow-md">
            Go back
          </a>
        </Link>
      </center>
